                ...
                <div class="row no-gutters">
                    <div class="col-md-4">
                        <div class="card-body">
                            ...
                            <br>
                            <span class="card-title"><b>Numero cuartos:</b> {{ departamento.numero_cuartos }}</span>
                            <br>
                            <span class="card-text"><b>Numero baños:</b> {{ departamento.numero_banos }}</span>
                            <br>
                    ...
                    <div class="col-md-8">
                        <div class="card-body">
                            <span class="card-text"><b>Estudiante:</b> {{ departamento.estudiante_str }}</span>
                        </div>
                    </div>
                </div>
            </div>
